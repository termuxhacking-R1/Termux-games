...
echo "       ░       ░  ░       ░      ░  ░      ░          " | lolcat -s 100000
echo "------------------------------------------------------" | lolcat
echo "-----------[ Instagram : @termuxhacking11 ]-----------" | lolcat -as 50
echo "------------------------------------------------------" | lolcat 
...
;;
	...
	echo "[-----------------------------------------------------]" | lolcat -as 100
	echo " [ɴᴀᴍᴇ] = [T-O-R1] " | lolcat -as 50
	echo ""
	echo " [ɢɪᴛʜᴜʙ] = [https://github.com/termuxhacking-R1] " | lolcat -as 50
	echo ""
	echo "[ɪɴsᴛᴀɢʀᴀᴍ]" = [www.instagram.com/termuxhacking11/] | lolcat -as 50
	echo "[-----------------------------------------------------]" | lolcat -as 100
